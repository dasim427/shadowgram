...
public struct ChatMessageItemLayoutConstants {
    ...
    public static var compact: ChatMessageItemLayoutConstants {
        ...
        let sgPadding = CGFloat(SGExtrasManager.shared.bubblePadding)
        let text = ChatMessageItemTextLayoutConstants(bubbleInsets: UIEdgeInsets(top: 6.0 + UIScreenPixel + sgPadding * 0.5, left: 11.0 + sgPadding, bottom: 6.0 - UIScreenPixel + sgPadding * 0.5, right: 11.0 + sgPadding))
    ...
    public static var regular: ChatMessageItemLayoutConstants {
        ...
        let sgPadding = CGFloat(SGExtrasManager.shared.bubblePadding)
        let text = ChatMessageItemTextLayoutConstants(bubbleInsets: UIEdgeInsets(top: 6.0 + UIScreenPixel + sgPadding * 0.5, left: 10.0 + sgPadding, bottom: 6.0 - UIScreenPixel + sgPadding * 0.5, right: 10.0 + sgPadding))
